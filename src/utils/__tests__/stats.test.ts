...
const SESSIONS: Session[] = [
  { id: 's1', user_id: 'u1', date: '2026-05-20', location: 'Gym', duration_minutes: 90, intensity: null, notes: null, created_at: '' },
  { id: 's2', user_id: 'u1', date: '2026-05-22', location: 'Kilter', duration_minutes: 60, intensity: null, notes: null, created_at: '' },
]

const PROBLEMS: Problem[] = [
  { id: 'p1', session_id: 's1', user_id: 'u1', name: null, grade_system: 'font', grade_value: '7A', color: null, attempts: 3, sent: true, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, notes: null, created_at: '' },
  { id: 'p2', session_id: 's1', user_id: 'u1', name: null, grade_system: 'v_scale', grade_value: 'V5', color: null, attempts: 1, sent: false, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, notes: null, created_at: '' },
  { id: 'p3', session_id: 's2', user_id: 'u1', name: null, grade_system: 'font', grade_value: '6B+', color: null, attempts: 2, sent: true, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, notes: null, created_at: '' },
]
...
describe('sessionsByWeek', () => {
  ...
  it('counts sessions in the correct week bucket', () => {
    ...
    const sessions: Session[] = [
      { id: 's1', user_id: 'u1', date: dateStr, location: 'Gym', duration_minutes: 60, intensity: null, notes: null, created_at: '' },
    ]
  ...
  it('excludes sessions outside the window', () => {
    ...
    const sessions: Session[] = [
      { id: 's1', user_id: 'u1', date: oldDate, location: 'Gym', duration_minutes: 60, intensity: null, notes: null, created_at: '' },
    ]
    const result = sessionsByWeek(sessions, 14)
    const totalCount = result.reduce((sum, b) => sum + b.count, 0)
...
describe('hardestSentPerSession', () => {
  ...
  it('omits sessions with no sent problems', () => {
    const sessions: Session[] = [
      { id: 's1', user_id: 'u1', date: SESSIONS[0].date, location: 'Gym', duration_minutes: 60, intensity: null, notes: null, created_at: '' },
    ]
  ...
  it('picks the hardest sent grade per session', () => {
    ...
    const problems: Problem[] = [
      ...
      { id: 'p2', session_id: 's1', user_id: 'u1', name: null, grade_system: 'font', grade_value: '7A', color: null, attempts: 1, sent: true, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, notes: null, created_at: '' },
    ]
  ...
  it('excludes sessions outside the window', () => {
    const oldSession: Session[] = [
      { id: 's1', user_id: 'u1', date: '2020-01-01', location: 'Gym', duration_minutes: 60, intensity: null, notes: null, created_at: '' },
    ]
    const problems: Problem[] = [
