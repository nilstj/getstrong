...
const PROBLEMS: Problem[] = [
  { id: 'p1', session_id: 's1', user_id: 'u1', name: null, grade_system: 'font', grade_value: '7A', color: null, attempts: 3, sent: true, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, crag: null, notes: null, created_at: '' },
  { id: 'p2', session_id: 's1', user_id: 'u1', name: null, grade_system: 'v_scale', grade_value: 'V5', color: null, attempts: 1, sent: false, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, crag: null, notes: null, created_at: '' },
  { id: 'p3', session_id: 's2', user_id: 'u1', name: null, grade_system: 'font', grade_value: '6B+', color: null, attempts: 2, sent: true, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, crag: null, notes: null, created_at: '' },
]
...
describe('hardestSentPerSession', () => {
  ...
  it('omits sessions with no sent problems', () => {
    ...
    const unseated: Problem[] = [
      { id: 'p1', session_id: 's1', user_id: 'u1', name: null, grade_system: 'font', grade_value: '7A', color: null, attempts: 2, sent: false, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, crag: null, notes: null, created_at: '' },
    ]
  ...
  it('picks the hardest sent grade per session', () => {
    ...
    const problems: Problem[] = [
      { id: 'p1', session_id: 's1', user_id: 'u1', name: null, grade_system: 'font', grade_value: '4', color: null, attempts: 1, sent: true, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, crag: null, notes: null, created_at: '' },
      { id: 'p2', session_id: 's1', user_id: 'u1', name: null, grade_system: 'font', grade_value: '7A', color: null, attempts: 1, sent: true, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, crag: null, notes: null, created_at: '' },
    ]
  ...
  it('excludes sessions outside the window', () => {
    ...
    const problems: Problem[] = [
      { id: 'p1', session_id: 's1', user_id: 'u1', name: null, grade_system: 'font', grade_value: '7A', color: null, attempts: 1, sent: true, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, crag: null, notes: null, created_at: '' },
    ]
