...
const PROBLEMS: Problem[] = [
  { id: 'p1', session_id: 's1', user_id: 'u1', name: null, grade_system: 'font', grade_value: '7A', color: null, hold_color: null, attempts: 3, sent: true, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, image_url: null, crag: null, notes: null, created_at: '', gym_problem_id: null, group_boulder_id: null },
  { id: 'p2', session_id: 's1', user_id: 'u1', name: null, grade_system: 'v_scale', grade_value: 'V5', color: null, hold_color: null, attempts: 1, sent: false, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, image_url: null, crag: null, notes: null, created_at: '', gym_problem_id: null, group_boulder_id: null },
  { id: 'p3', session_id: 's2', user_id: 'u1', name: null, grade_system: 'font', grade_value: '6B+', color: null, hold_color: null, attempts: 2, sent: true, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, image_url: null, crag: null, notes: null, created_at: '', gym_problem_id: null, group_boulder_id: null },
]
...
describe('hardestSentPerSession', () => {
  ...
  it('omits sessions with no sent problems', () => {
    ...
    const unseated: Problem[] = [
      { id: 'p1', session_id: 's1', user_id: 'u1', name: null, grade_system: 'font', grade_value: '7A', color: null, hold_color: null, attempts: 2, sent: false, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, image_url: null, crag: null, notes: null, created_at: '', gym_problem_id: null, group_boulder_id: null },
    ]
  ...
  it('picks the hardest sent grade per session', () => {
    ...
    const problems: Problem[] = [
      { id: 'p1', session_id: 's1', user_id: 'u1', name: null, grade_system: 'font', grade_value: '4', color: null, hold_color: null, attempts: 1, sent: true, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, image_url: null, crag: null, notes: null, created_at: '', gym_problem_id: null, group_boulder_id: null },
      { id: 'p2', session_id: 's1', user_id: 'u1', name: null, grade_system: 'font', grade_value: '7A', color: null, hold_color: null, attempts: 1, sent: true, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, image_url: null, crag: null, notes: null, created_at: '', gym_problem_id: null, group_boulder_id: null },
    ]
  ...
  it('excludes sessions outside the window', () => {
    ...
    const problems: Problem[] = [
      { id: 'p1', session_id: 's1', user_id: 'u1', name: null, grade_system: 'font', grade_value: '7A', color: null, hold_color: null, attempts: 1, sent: true, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: null, beta_video_url: null, image_url: null, crag: null, notes: null, created_at: '', gym_problem_id: null, group_boulder_id: null },
    ]
...
describe('sentGymGradeCounts', () => {
  ...
  const problem = (id: string, sessionId: string, color: string | null, sent: boolean): Problem =>
    ({ id, session_id: sessionId, user_id: 'u1', name: null, grade_system: 'font', grade_value: '6A', color, hold_color: null, attempts: 1, sent, grade_value_font: null, grade_value_vscale: null, board: null, board_angle: null, gym: 'Gym', beta_video_url: null, image_url: null, crag: null, notes: null, created_at: '', gym_problem_id: null, group_boulder_id: null })
